...
void IMU::setInitialOrientation() {
  updateRawData();
...
void IMU::getRPH(float *r, float *p, float *h)
{
  *r = roll;
  *p = pitch;
  *h = heading;
...
void IMU::getAccRPY(float *r, float *p, float *y)
{
  *r = aRoll;
  *p = aPitch;
  *y = aYaw;
...
void IMU::getGyroRPY(float *r, float *p, float *y)
{
  *r = gRoll;
  *p = gPitch;
  *y = gYaw;
